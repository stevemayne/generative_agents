...
from utils import create_completion, create_embedding, gpt_request, HERE
...
def generate_prompt(curr_input, prompt_lib_file):
    ...
    f = open(os.path.join(HERE, prompt_lib_file), "r")
    prompt = f.read()
    f.close()
...
if __name__ == "__main__":
    ...
    prompt_lib_file = os.path.join(HERE, "prompt_template/test_prompt_July5.txt")
