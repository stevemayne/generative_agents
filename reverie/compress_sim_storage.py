...
def compress(sim_code):
    sim_storage = os.path.join(
        HERE, f"../environment/frontend_server/storage/{sim_code}"
    )
    compressed_storage = os.path.join(
        HERE, f"../environment/frontend_server/compressed_storage/{sim_code}"
    )
